...
class ATTACHMENT
{
    ...
    public function enable_attachment()
    {
    ...
    public function set_count_so_far()
    {
        $userid = $this->userid;
        $now = date('Y-m-d H:i:s', TIMENOW - 86400);
        $countsofar = NexusDB::table('attachments')
    ...
    public function get_count_so_far()
    {
        return $this->countsofar;
    }

    public function get_count_limit_class($class)
    {
    ...
    public function set_count_limit()
    {
        $class = $this->class;
    ...
    public function get_count_limit()
    {
        return $this->countlimit;
    }

    public function get_count_left()
    {
    ...
    public function get_size_limit_class($class)
    {
    ...
    public function set_size_limit()
    {
        $class = $this->class;
    ...
    public function get_size_limit_kb()
    {
        return $this->sizelimit;
    }

    public function get_size_limit_byte()
    {
        return $this->sizelimit * 1024;
    }

    public function get_allowed_ext_class($class)
    {
    ...
    public function extract_allowed_ext($string)
    {
    ...
    public function is_gif_ani($filename)
    {
