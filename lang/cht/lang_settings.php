...
(
	...
	'head_save_bonus_settings' => "儲存蝌蚪設定",
	...
	'row_kps_enabled' => "開啟蝌蚪系統",
	'text_enabled' => "開啟",
	'text_disabled_but_save' => "關閉但仍記錄數值",
	'text_disabled_no_save' => "完全關閉",
	'text_kps_note' => "預設‘開啟’。開啟或關閉蝌蚪系統，是否記錄數值。",
	...
	'text_general_profile_management_note' => "。改變用戶的基本檔案，但無法改變其中重要的項目，如郵箱位址、用戶名、上傳量、下載量、蝌蚪數。",
	...
	'text_buy_invites_note' => "。允許在蝌蚪中心購買邀請。",
	...
	'head_bonus_settings' => "蝌蚪設定",
	'text_bonus_by_seeding' => "做種獲得蝌蚪",
	'row_donor_gets_double' => "捐贈者加倍",
	'text_donor_gets' => "捐贈者通過做種能獲得正常情況",
	'text_times_as_many' => "倍的蝌蚪。預設'2'。設為'0'則將捐贈者和其他用戶同等對待。",
	'row_basic_seeding_bonus' => "基礎做種蝌蚪",
	'text_user_would_get' => "對于每個做種中的種子，用戶將獲得",
	'text_bonus_points' => "個蝌蚪，最多計算",
	'text_torrents_default' => "個種子。預設'1'，'7'。將蝌蚪數設為'0'來禁止此規則。",
	'row_seeding_formula' => "做種公式",
	'text_bonus_formula_one' => "每小時獲得的蝌蚪點數由下面的公式給出",
	'text_where' => "式中",
	...
	'text_bonus_formula_eight' => "<b>B</b>為1小時中用戶獲得的做種蝌蚪點數",
	'text_bonus_formula_nine' => "<b>B0</b>為參數，代表用戶1小時獲得蝌蚪的上限。<b>B0</b> = ",
	...
	'text_uploading_torrent_note' => "個蝌蚪，如果他發布一個新種子。預設'15'。",
	'row_uploading_subtitle' => "上傳一個字幕",
	'text_uploading_subtitle_note' => "個蝌蚪，如果他上傳一個字幕。預設'5'。",
	'row_starting_topic' => "發布新主題",
	'text_starting_topic_note' => "個蝌蚪，如果他在論壇發布一個新的主題。預設'2'。",
	'row_making_post' => "回覆帖子",
	'text_making_post_note' => "個蝌蚪，如果他在論壇發布一個帖子。預設'1'。",
	'row_adding_comment' => "發布評論",
	'text_adding_comment_note' => "個蝌蚪，如果他對種子、候選發表了一次評論。預設'1'。",
	'row_voting_on_poll' => "參與調查投票",
	'text_voting_on_poll_note' => "個蝌蚪，如果他參與一次調查投票。預設'1'。",
	'row_voting_on_offer' => "參與候選投票",
	'text_voting_on_offer_note' => "個蝌蚪，如果他參與一次候選投票。預設'1'。",
	'row_voting_on_funbox' => "趣味盒投票",
	'text_voting_on_funbox_note' => "個蝌蚪，如果他參與一次趣味盒投票。預設'1'。",
	'row_saying_thanks' => "說謝謝",
	'text_giver_and_receiver_get' => "感謝表達者和接受者將分別得到",
	'text_saying_thanks_and' => "和",
	'text_saying_thanks_default' => "個蝌蚪。預設'0.5'，'0'。",
	'row_funbox_stuff_reward' => "趣味盒獎勵",
	'text_funbox_stuff_reward_note' => "個蝌蚪，如果他發布的趣味盒內容被評為“有趣”。預設'5'。",
	'text_things_cost_bonus' => "消耗蝌蚪的項目",
	'row_one_gb_credit' => "1.0 GB上傳量",
	'text_it_costs_user' => "用戶將失去",
	'text_one_gb_credit_note' => "個蝌蚪，如果他選取交換1.0 GB上傳量。預設'300'。",
	'row_five_gb_credit' => "5.0 GB上傳量",
	'text_five_gb_credit_note' => "個蝌蚪，如果他選取交換5.0 GB上傳量。預設'800'。",
	'row_ten_gb_credit' => "10.0 GB上傳量",
	'text_ten_gb_credit_note' => "個蝌蚪，如果他選取交換5.0 GB上傳量。預設'1200'。",
	...
	'text_buy_an_invite_note' => "個蝌蚪，如果他選取交換一個邀請名額。預設'1000'。將蝌蚪設為'0'來禁止購買。",

	'row_custom_title' => "自訂頭銜",
	'text_custom_title_note' => "個蝌蚪，如果他選取自訂一次頭銜。預設'5000'。",
	'row_vip_status' => "貴賓待遇",
	'text_vip_status_note' => "個蝌蚪，如果他選取給自己換取一個月的貴賓待遇。預設'8000'。",
	'row_allow_giving_bonus_gift' => "允許蝌蚪贈送",
	'text_giving_bonus_gift_note' => "允許用戶間相互贈送蝌蚪。預設'是'。",
	...
	'text_cleanup_interval_note_one' => "每XXX秒時間做自動清理工作（用戶升級、降級、添加做種蝌蚪等）。",
	'text_priority_one' => "優先級1：",
	'text_priority_one_note' => "更新同伴狀態；添加做種蝌蚪。預設'3600'，即60分鐘。",
	...
	'row_bonus_settings' => "蝌蚪設定",
	'submit_bonus_settings' => "蝌蚪設定",
	'text_bonus_settings_note' => "配置蝌蚪的抓取和使用。",
	...
	'row_bonus_gift_tax' => "蝌蚪贈送稅收",
	'text_system_charges' => "系統向禮物接收者索取",
	'text_bonus_points_plus' => "個蝌蚪 + 贈送額的",
	'text_bonus_gift_tax_note' => "%的蝌蚪作為稅收。如設為'5'，'10'時，禮物贈送者傳送100個蝌蚪，接收者只獲得85個。預設'5'，'10'。<br /><b>注意</b>：兩條規則是分開執行的，將兩個值都設為'0'才能完全免除稅收。",
	...
	'row_bonus_no_advertisement' => "蝌蚪交換可關閉廣告",
	'text_no_advertisement_with_bonus' => "及以上等級用戶可用蝌蚪換取一定期限內不察看廣告的許可權。預設",
	'row_no_advertisement_bonus_price' => "無廣告蝌蚪",
	'text_bonus_points_to_buy' => "個蝌蚪，如果他選取交換",
	'text_days_without_advertisements' => "天不察看廣告的許可權。預設'10000'，'15'。",
	'row_click_advertisement_bonus' => "點擊廣告抓取蝌蚪",
	'text_points_clicking_on_advertisements' => "個蝌蚪，如果他第一次點擊某個廣告。設為'0'來禁用此規則。<br /><b>注意</b>：一些廣告服務（如Google Adsense）禁止網站激勵用戶點擊廣告的行為。",
	...
	'text_promotion_link_note_one' => "個蝌蚪，如果他的宣傳鏈結獲得一次來自一個未記錄的IP的點擊。",
	'text_promotion_link_note_two' => "秒內最多獎勵一次點擊。將蝌蚪設為'0'來禁用宣傳鏈結功能。預設'0'，'600'。",
    ...
    'text_cancel_hr_note' => "個蝌蚪，如果他需要消除一個 H&R。默認'".\App\Models\BonusLogs::DEFAULT_BONUS_CANCEL_ONE_HIT_AND_RUN."''。",
    'text_attendance_get_bonus' => '簽到獲得蝌蚪',
    'text_attendance_initial_reward' => '初始獎勵',
    'text_attendance_initial_reward_input_label' => '第一次簽到獲得',
    'text_attendance_input_suffix' => '蝌蚪',
    ...
    'text_attendance_card_note' => "個蝌蚪，如果他需要購買一張補簽卡。默認'" . \App\Models\BonusLogs::DEFAULT_BONUS_BUY_ATTENDANCE_CARD . "'。",
    ...
    'claim_remove_deduct_user_bonus' => '種子不達標時將被刪除並扣除用戶 %s 蝌蚪(非認領首月)。',
    'claim_give_up_deduct_user_bonus' => '用戶主動放棄認領扣除用戶 %s 蝌蚪。',
    'claim_reach_standard' => '達標標準：每月做種時間大於等於 %s 小時, 或上傳量大於等於其體積 %s 倍。',
    'claim_bonus_multiplier' => '計算達標種子蝌蚪獎勵是正常蝌蚪的 %s 倍。',
    ...
    'text_user_would_get_by_harem' => '用戶將獲得直屬後宮蝌蚪的',
    'text_harem_addition_note' => '倍作為獎勵（系數，如填入 0.01，後宮獲得 100 蝌蚪則獎勵用戶 100 * 0.01 = 1）',
    ...
    'text_hundred_gb_credit_note' => "個蝌蚪，如果他選擇交換100.0 GB上傳量。默認'10000'。",
    'row_ten_gb_download_credit' => "10.0 GB 下載量",
    'text_ten_gb_download_credit_note' => " 個蝌蚪，如果他選擇交換10.0 GB下載量。默認'1000'。",
    'row_hundred_gb_download_credit' => "100.0 GB 下載量",
    'text_hundred_gb_download_credit_note' => " 個蝌蚪，如果他選擇交換100.0 GB下載量。默認'8000'。",
    'row_official_addition' => '官種加成',
    'text_user_would_get_by_official' => '用戶將獲得官種正常蝌蚪的',
    'text_addition_addition_note' => '倍作為獎勵（系數，如填入 0.01，官種獲得 100 蝌蚪則獎勵用戶 100 * 0.01 = 1）',
    ...
    'text_buy_an_tmp_invite_note' => "個蝌蚪，如果他選擇交換一個臨時邀請名額。默認'500'。將蝌蚪設為'0'來禁止購買。",
    'row_buy_rainbow_id' => '購買彩虹 ID',
    'text_buy_rainbow_id_note' => "個蝌蚪，如果他選擇交換一個彩虹 ID，有效期 30 天。默認'5,000'。",
    'row_buy_change_username_card' => '購買改名卡',
    'text_buy_change_username_card_note' => "個蝌蚪，如果他選擇交換一個改名卡，永久有效。默認'100,000'。",
    ...
    'text_paid_torrent_enabled_note' => '啟用後，有權限的用戶可以在發種時設置向下載種子的用戶收取一定的蝌蚪，默認：否',
);
