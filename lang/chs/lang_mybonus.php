...
(
	'std_sorry' => "对不起！",
	'std_karma_system_disabled' => "蝌蚪系统当前处于关闭中。",
	'std_points_active' => "不过你的蝌蚪仍在计算中。",
	...
	'text_success_gift' => "你成功赠送了<b>蝌蚪</b>。",
	'head_karma_page' => "的蝌蚪",
	'text_karma_system' => "蝌蚪系统",
	'text_exchange_your_karma' => "用你的蝌蚪（当前",
	'text_for_goodies' => "）换东东！",
	'text_no_buttons_note' => "如果按钮不可点，则你的蝌蚪不足以交换该项。",
	'col_option' => "项目",
	'col_description' => "简介",
	'col_points' => "价格",
	'col_trade' => "交换",
	...
	'text_karma_points' => " 个蝌蚪！",
	'text_enter_titile' => "输入你想要的<b>特殊头衔</b> ",
	'text_click_exchange' => " 点击交换！",
	'text_enter_receiver_name' => "输入赠送蝌蚪对象的<b>用户名</b>，选择赠送量然后点击赠送!",
	'text_min' => "最少",
	'text_max' => "最多",
	...
	'text_what_is_karma' => "蝌蚪到底是什么玩意儿，我怎样才能得到它？",
	'text_get_by_seeding' => "做种每小时将得到如下的蝌蚪",
...
<h1>注意点</h1>
<ul>",
	'text_howto_get_karma_five' => "<li>与获取相反的事件也会消耗你的蝌蚪。<br />如：如果你上传种子后又删除了它，你会先得到然后又失去",
	'text_howto_get_karma_six' => "。</li>
	<li>站点还有其他获取蝌蚪的事，请慢慢探索。:)</li>
	<li>管理组可以剥夺或发放蝌蚪，视用户是违反规则还是做贡献而定。</li>
</ul>",
	'std_no_permission' => "没有该权限",
	'std_class_above_vip' => "你的等级比VIP高！",
	'text_wasted_karma' => "我刚刚浪费了蝌蚪",
	'text_huh' => "恩？",
	'text_karma_self_giving_warning' => "哥们，你玩够了吗...<br />你不能将蝌蚪送给自己...<br />如果要送，选择其他用户！<br /><br />点击返回<a class=altlink href=mybonus.php>蝌蚪页面</a>。",
	'text_receiver_not_exists' => "对不起...<br />不存在该用户。<br /><br />点击回到你的<a class=altlink href=mybonus.php>蝌蚪页面</a>。",
	'text_oups' => "啊哦!",
	'text_not_enough_karma' => "<b>对不起</b>，你没有足够的蝌蚪！<br />点击回到你的<a class=altlink href=mybonus.php>蝌蚪页面</a>。",
	'text_cheat_alert' => "想作弊？没门！",
	'text_not_enough_bonus' => "对不起，你没有足够的蝌蚪。还有，你怎么到这来的？",
	'text_uploaded_one' => "1.0 GB上传量",
	'text_uploaded_note' => "如果有足够的蝌蚪，你可以用它来换取上传量。交易完成后，你的蝌蚪会减少，上传量则会增加。",
	'text_download_note' => "如果有足够的蝌蚪，你可以用它来换取<font color='#ff4500'>下载量</font>。交易完成后，你的蝌蚪会减少，<font color='#ff4500'>下载量</font>则会增加。",
	...
	'text_buy_invite_note' => "如果有足够的蝌蚪，你可以用它来换取邀请名额。交易完成后，你的蝌蚪会减少，邀请名额数则会增加。",
	'text_custom_title' => "自定义头衔",
	'text_custom_title_note' => "如果有足够的蝌蚪，你就可以给自己定一个头衔了。注意：禁止使用脏话、攻击性的词汇或用户等级作为头衔。交易完成后，你的蝌蚪会减少，你的头衔将变成自定义的。",
	'text_vip_status' => "贵宾待遇",
	'text_vip_status_note' => "如果有足够的蝌蚪，你可以用它来换取一个月的贵宾待遇。交易完成后，你的蝌蚪会减少，同时你的等级将变为贵宾。",
	'text_bonus_gift' => "赠送蝌蚪",
	'text_bonus_gift_note' => "可能你不需要蝌蚪，为什么不把它送给那些需要的人呢？你可以把自己的蝌蚪作为礼物送给别人。交易完成后，你的蝌蚪会减少，礼物接收者的蝌蚪则会增加。同时，接收者会收到一条关于你的馈赠的短讯。",
	'text_error' => "错误",
	'text_ratio_too_high' => "分享率已很高",
	'text_bonus_formula_one' => "每小时获得的蝌蚪点数由下面的公式给出<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;<img src=pic/bonusformulaa.png ><br />&nbsp;&nbsp;&nbsp;&nbsp;<img src=pic/bonusformulab.png ><br />
式中<ul><li><b>K1</b>为常数0.05</li><li><b>K2</b>为为常数100</li><li><b>T0</b>为参数。<b>T0</b> = ",
	'text_bonus_formula_two' => "</li><li><b>Si</b>为第<b>i</b>个种子的大小，单位是GB</li><li><b>Ni</b>为第<b>i</b>个种子当前的做种者数</li><li><b>N0</b>为参数。<b>N0</b> = ",
	'text_bonus_formula_three' => "</li><li><b>B</b>为1小时中用户获得的做种蝌蚪点数</li><li><b>B0</b>为参数，代表用户1小时获得蝌蚪的上限。<b>B0</b> = ",
	'text_bonus_formula_four' => "</li><li><b>L</b>为参数。<b>L</b> = ",
	'text_bonus_formula_five' => "</li></ul>简言之，为做种人数少、文件体积大的种子做种能获得更多蝌蚪。",
	...
	'text_per_hour' => "",
	'text_custom' => "自定义",
	'bonus_amount_not_allowed' => "蝌蚪数量不允许。你每次只能赠送25.0至1000.0个蝌蚪。",
	'text_system_charges_receiver' => "<b>注意：</b>系统向礼物接收者索取",
	'text_tax_bonus_point' => "个蝌蚪",
	'text_tax_plus' => " + ",
	'text_percent_of_transfered_amount' => "% * 赠送额的蝌蚪",
	'text_as_tax' => "作为税收。例如，当你选择赠送100个蝌蚪，接收者实际只收到",
	'text_tax_example_note' => "个蝌蚪。",
	'text_no_advertisements' => "天不显示广告",
	'text_no_advertisements_note' => "如果有足够的蝌蚪，你可以用它来换取一定期限内不显示广告的权限。交易完成后，你的蝌蚪会减少，同时在一定期限内你将看不到网站中的广告。如果在此期间你需要显示广告，你可以随时在控制面板开启它。",
	...
	'text_charity_giving_note' => "你可以将你的蝌蚪通过慈善捐赠送与有需要的用户群体。而且，完全由你决定赠与群体的条件。",
	'text_ratio_below' => "平均分配给用户：分享率低于",
	'text_and_downloaded_above' => "且下载量大于",
	'text_select_receiver_ratio' => "选择你想捐赠予的用户群体的<b>分享率</b>，选择你想赠送的蝌蚪总值，然后点击<b>慈善捐赠</b>！",
	'submit_charity_giving' => "慈善捐赠",
	'text_message' => "留言：",
	'bonus_amount_not_allowed_two' => "蝌蚪数量不允许。你每次只能赠送1000.0至50000.0个蝌蚪。",
    ...
    'text_attendance_card_note' => '补签一天消耗一张，补签目标日期所得蝌蚪奖励按照正常计算，即目标日期往前推计算连续天数获得奖励。',
    'text_success_buy_attendance_card' => '成功购买了一张补签卡。',
    'text_harem_addition_get' => '当前后宫加成每小时获得 %s 蝌蚪',
    'reward_type' => '奖励类型',
    'factor' => '系数',
    'got_bonus' => '获得蝌蚪',
    'total' => '合计',
    ...
    'text_get_by_seeding_official' => '官种加成每小时将额外得到如下的蝌蚪',
    ...
    'text_get_by_harem' => '后宫加成每小时将额外得到如下的蝌蚪',
    ...
    'text_bonus_summary' => '每小时获得的合计蝌蚪',
    'col_count' => '数量',
    'col_size' => '体积',
    'col_a' => 'A 值',
    'text_buy_tmp_invite' => '1个临时邀请名额',
    'text_buy_tmp_invite_note' => '如果有足够的蝌蚪，你可以用它来换取临时邀请名额，有效期 7 天。交易完成后，你的蝌蚪会减少，邀请临时名额数则会增加。',
    ...
    'text_get_by_medal' => '勋章加成每小时将额外得到如下的蝌蚪',
