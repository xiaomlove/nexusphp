...
$lang_viewrequests = [
    ...
    'on_request' => '应求',
    'recycle' => '回收',
    'recycle_title' => '回收返还80%蝌蚪',
    'add_reward' => '追加悬赏',
    'add_reward_desc' => '追加悬赏每次将扣减25个蝌蚪作为手续费',
    'no_request_yet' => '还没有应求',
    'btn_select_text' => '使用勾选的资源作为所需资源',
    'request_already_resolved' => '该求种已完成！',
    'add_request_desc' => '赏金不得低于100蝌蚪，每次求种将扣去100蝌蚪作为手续费。',
    'description_required' => '介绍未填!',
    'name_required' => '名称未填!',
    'amount_required' => '赏金未填!',
    'amount_must_be_numeric' => '赏金必须为数字!',
    'add_request_amount_minimum' => '发布求种赏金不得小于100个蝌蚪！',
    'add_request_amount_maximum' => '发布求种赏金不得大于10000个蝌蚪！',
    'bouns_not_enough' => '你没有那么多蝌蚪！！！',
    ...
    'supply_success' => '应求成功',
    'add_reward_amount_minimum' => '追加悬赏赏金不得小于100个蝌蚪！',
    'add_reward_amount_maximum' => '追加悬赏赏金不得大于5000个蝌蚪！',
