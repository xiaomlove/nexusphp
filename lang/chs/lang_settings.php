...
(
	...
	'head_save_bonus_settings' => "保存蝌蚪设定",
	...
	'row_kps_enabled' => "开启蝌蚪系统",
	'text_enabled' => "开启",
	'text_disabled_but_save' => "关闭但仍记录数值",
	'text_disabled_no_save' => "完全关闭",
	'text_kps_note' => "默认‘开启’。开启或关闭蝌蚪系统，是否记录数值。",
	...
	'text_general_profile_management_note' => "。改变用户的基本档案，但不能改变其中重要的项目，如邮箱地址、用户名、上传量、下载量、蝌蚪数。",
	...
	'text_buy_invites_note' => "。允许在蝌蚪中心购买邀请。",
	...
	'head_bonus_settings' => "蝌蚪设定",
	'text_bonus_by_seeding' => "做种获得蝌蚪",
	'row_donor_gets_double' => "捐赠者加倍",
	'text_donor_gets' => "捐赠者通过做种能获得正常情况",
	'text_times_as_many' => "倍的蝌蚪。默认'2'。设为'0'则将捐赠者和其他用户同等对待。",
	'row_basic_seeding_bonus' => "基础做种蝌蚪",
	'text_user_would_get' => "对于每个做种中的种子，用户将获得",
	'text_bonus_points' => "个蝌蚪，最多计算",
	'text_torrents_default' => "个种子。默认'1'，'7'。将蝌蚪数设为'0'来禁止此规则。",
	'row_seeding_formula' => "做种公式",
	'text_bonus_formula_one' => "每小时获得的蝌蚪点数由下面的公式给出",
	'text_where' => "式中",
	...
	'text_bonus_formula_eight' => "<b>B</b>为1小时中用户获得的做种蝌蚪点数",
	'text_bonus_formula_nine' => "<b>B0</b>为参数，代表用户1小时获得蝌蚪的上限。<b>B0</b> = ",
	...
	'text_uploading_torrent_note' => "个蝌蚪，如果他发布一个新种子。默认'15'。",
	'row_uploading_subtitle' => "上传一个字幕",
	'text_uploading_subtitle_note' => "个蝌蚪，如果他上传一个字幕。默认'5'。",
	'row_starting_topic' => "发布新主题",
	'text_starting_topic_note' => "个蝌蚪，如果他在论坛发布一个新的主题。默认'2'。",
	'row_making_post' => "回复帖子",
	'text_making_post_note' => "个蝌蚪，如果他在论坛发布一个帖子。默认'1'。",
	'row_adding_comment' => "发布评论",
	'text_adding_comment_note' => "个蝌蚪，如果他对种子、候选发表了一次评论。默认'1'。",
	'row_voting_on_poll' => "参与调查投票",
	'text_voting_on_poll_note' => "个蝌蚪，如果他参与一次调查投票。默认'1'。",
	'row_voting_on_offer' => "参与候选投票",
	'text_voting_on_offer_note' => "个蝌蚪，如果他参与一次候选投票。默认'1'。",
	'row_voting_on_funbox' => "趣味盒投票",
	'text_voting_on_funbox_note' => "个蝌蚪，如果他参与一次趣味盒投票。默认'1'。",
	'row_saying_thanks' => "说谢谢",
	'text_giver_and_receiver_get' => "感谢表达者和接受者将分别得到",
	'text_saying_thanks_and' => "和",
	'text_saying_thanks_default' => "个蝌蚪。默认'0.5'，'0'。",
	'row_funbox_stuff_reward' => "趣味盒奖励",
	'text_funbox_stuff_reward_note' => "个蝌蚪，如果他发布的趣味盒内容被评为“有趣”。默认'5'。",
	'text_things_cost_bonus' => "消耗蝌蚪的项目",
	'row_one_gb_credit' => "1.0 GB上传量",
	'text_it_costs_user' => "用户将失去",
	'text_one_gb_credit_note' => "个蝌蚪，如果他选择交换1.0 GB上传量。默认'300'。",
	'row_five_gb_credit' => "5.0 GB上传量",
	'text_five_gb_credit_note' => "个蝌蚪，如果他选择交换5.0 GB上传量。默认'800'。",
	'row_ten_gb_credit' => "10.0 GB上传量",
	'text_ten_gb_credit_note' => "个蝌蚪，如果他选择交换5.0 GB上传量。默认'1200'。",
	...
	'text_buy_an_invite_note' => "个蝌蚪，如果他选择交换一个邀请名额。默认'1000'。将蝌蚪设为'0'来禁止购买。",
	'row_custom_title' => "自定义头衔",
	'text_custom_title_note' => "个蝌蚪，如果他选择自定义一次头衔。默认'5000'。",
	'row_vip_status' => "贵宾待遇",
	'text_vip_status_note' => "个蝌蚪，如果他选择给自己换取一个月的贵宾待遇。默认'8000'。",
	'row_allow_giving_bonus_gift' => "允许蝌蚪赠送",
	'text_giving_bonus_gift_note' => "允许用户间相互赠送蝌蚪。默认'是'。",
	...
	'text_cleanup_interval_note_one' => "每XXX秒时间做自动清理工作（用户升级、降级、添加做种蝌蚪等）。",
	'text_priority_one' => "优先级1：",
	'text_priority_one_note' => "更新同伴状态；添加做种蝌蚪。默认'3600'，即60分钟。",
	...
	'row_bonus_settings' => "蝌蚪设定",
	'submit_bonus_settings' => "蝌蚪设定",
	'text_bonus_settings_note' => "配置蝌蚪的获取和使用。",
	...
	'row_bonus_gift_tax' => "蝌蚪赠送税收",
	'text_system_charges' => "系统向礼物接收者索取",
	'text_bonus_points_plus' => "个蝌蚪 + 赠送额的",
	'text_bonus_gift_tax_note' => "%的蝌蚪作为税收。如设为'5'，'10'时，礼物赠送者发送100个蝌蚪，接收者只获得85个。默认'5'，'10'。<br /><b>注意</b>：两条规则是分开执行的，将两个值都设为'0'才能完全免除税收。",
	...
	'row_bonus_no_advertisement' => "蝌蚪交换可关闭广告",
	'text_no_advertisement_with_bonus' => "及以上等级用户可用蝌蚪换取一定期限内不显示广告的权限。默认",
	'row_no_advertisement_bonus_price' => "无广告蝌蚪",
	'text_bonus_points_to_buy' => "个蝌蚪，如果他选择交换",
	'text_days_without_advertisements' => "天不显示广告的权限。默认'10000'，'15'。",
	'row_click_advertisement_bonus' => "点击广告获取蝌蚪",
	'text_points_clicking_on_advertisements' => "个蝌蚪，如果他第一次点击某个广告。设为'0'来禁用此规则。<br /><b>注意</b>：一些广告服务（如Google Adsense）禁止站点激励用户点击广告的行为。",
	...
	'text_promotion_link_note_one' => "个蝌蚪，如果他的宣传链接获得一次来自一个未记录的IP的点击。",
	'text_promotion_link_note_two' => "秒内最多奖励一次点击。将蝌蚪设为'0'来禁用宣传链接功能。默认'0'，'600'。",
    ...
    'text_cancel_hr_note' => "个蝌蚪，如果他需要消除一个 H&R。默认'".\App\Models\BonusLogs::DEFAULT_BONUS_CANCEL_ONE_HIT_AND_RUN."'。",
    'text_attendance_get_bonus' => '签到获得蝌蚪',
    ...
    'text_attendance_card_note' => "个蝌蚪，如果他需要购买一张补签卡。默认'" . \App\Models\BonusLogs::DEFAULT_BONUS_BUY_ATTENDANCE_CARD . "'。",
    ...
    'claim_remove_deduct_user_bonus' => '种子不达标时将被删除并扣除用户 %s 蝌蚪(非认领首月)。',
    'claim_give_up_deduct_user_bonus' => '用户主动放弃认领扣除用户 %s 蝌蚪。',
    'claim_reach_standard' => '达标标准：每月做种时间大于等于 %s 小时, 或上传量大于等于其体积 %s 倍。',
    'claim_bonus_multiplier' => '计算达标种子蝌蚪奖励是正常蝌蚪的 %s 倍。',
    ...
    'text_user_would_get_by_harem' => '用户将获得直属后宫蝌蚪的',
    'text_harem_addition_note' => '倍作为奖励（系数，如填入 0.01，后宫获得 100 蝌蚪则奖励用户 100 * 0.01 = 1）',
    ...
    'text_hundred_gb_credit_note' => "个蝌蚪，如果他选择交换100.0 GB上传量。默认'10000'。",
    'row_ten_gb_download_credit' => "10.0 GB 下载量",
    'text_ten_gb_download_credit_note' => " 个蝌蚪，如果他选择交换10.0 GB下载量。默认'1000'。",
    'row_hundred_gb_download_credit' => "100.0 GB 下载量",
    'text_hundred_gb_download_credit_note' => " 个蝌蚪，如果他选择交换100.0 GB下载量。默认'8000'。",
    'row_official_addition' => '官种加成',
    'text_user_would_get_by_official' => '用户将获得官种正常蝌蚪的',
    'text_addition_addition_note' => '倍作为奖励（系数，如填入 0.01，官种获得 100 蝌蚪则奖励用户 100 * 0.01 = 1）',
    ...
    'text_buy_an_tmp_invite_note' => "个蝌蚪，如果他选择交换一个临时邀请名额。默认'500'。将蝌蚪设为'0'来禁止购买。",
    'row_buy_rainbow_id' => '购买彩虹 ID',
    'text_buy_rainbow_id_note' => "个蝌蚪，如果他选择交换一个彩虹 ID，有效期 30 天。默认'5,000'。",
    'row_buy_change_username_card' => '购买改名卡',
    'text_buy_change_username_card_note' => "个蝌蚪，如果他选择交换一个改名卡，永久有效。默认'100,000'。",
    ...
    'text_paid_torrent_enabled_note' => '启用后，有权限的用户可以在发种时设置向下载种子的用户收取一定的蝌蚪，默认：否',
);
