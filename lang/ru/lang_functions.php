...
(
    ...
    'tooltip_hit_and_run' => 'Hit & Run: этот торрент проверяется на H&R. Удерживайте рейтинг >= 1 или сидируйте минимально требуемое число часов, иначе вашему аккаунту запишется предупреждение.',
    'tooltip_user_ratio' => 'Рейтинг раздачи = отдано / скачано. Ниже 1.0 значение становится красным — чем ниже рейтинг, тем темнее цвет. Подними его обратно сидируя.',
    'tooltip_user_class_format' => 'Класс пользователя: %s. Чем выше класс, тем больше уровень доверия и привилегий (дополнительные слоты, иммунитет к H&R и т.д.).',
);
