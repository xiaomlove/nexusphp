...
if ($action == 'view') {
    ...
    exit('This method is deprecated! This method is no longer available in 1.10, it does not save data correctly, please go to the management system!');
    try {
    ...
    $row = NexusDB::table('torrents_custom_fields')->where('id', (int) $id)->first();
    ...
    NexusDB::table('torrents_custom_fields')->where('id', (int) $id)->delete();
    nexus_redirect('fields.php?action=view');
}
