...
echo $lang_viewnfo['text_nfo_for']."<a href=details.php?id=$id>".htmlspecialchars($a['name'])."</a>\n";
...
if ($view == 'fonthack') {
    ...
    echo "<pre style=\"font-size:10pt; font-family: 'MS LineDraw', 'Terminal', monospace;white-space: break-spaces\">";
} else {
    ...
    echo "<pre style=\"font-size:10pt; font-family: 'Courier New', monospace;white-space: break-spaces\">";
}
