...
return [
    ...
    'torrent' => [
        ...
        'claim_enabled' => 'no',
        'claim_torrent_ttl' => Claim::TORRENT_TTL,
        'claim_torrent_user_counts_up_limit' => Claim::USER_UP_LIMIT,
        'claim_user_torrent_counts_up_limit' => Claim::TORRENT_UP_LIMIT,
        'claim_remove_deduct_user_bonus' => Claim::REMOVE_DEDUCT,
        'claim_give_up_deduct_user_bonus' => Claim::GIVE_UP_DEDUCT,
        'claim_bonus_multiplier' => Claim::BONUS_MULTIPLIER,
        'claim_reach_standard_seed_time' => Claim::STANDARD_SEED_TIME_HOURS,
        'claim_reach_standard_uploaded' => Claim::STANDARD_UPLOADED_TIMES,
    ...
    'meilisearch' => [
        ...
        'default_search_mode' => SearchBox::SEARCH_MODE_EXACT,
    ],
    'system' => [
