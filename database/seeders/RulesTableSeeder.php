...
[*]票数超过25，其中认为“有趣”比例超过50%，发布者得到5个蝌蚪。
[*]票数超过50，其中认为“有趣”比例超过50%，发布者得到另外的5个蝌蚪。
[*]票数超过100，其中认为“有趣”比例超过50%，发布者得到另外的5个蝌蚪。
[*]票数超过200，其中认为“有趣”比例超过50%，发布者得到另外的5个蝌蚪。
[*]票数超过25，其中认为“有趣”比例超过75%，发布者得到10个蝌蚪。
[*]票数超过50，其中认为“有趣”比例超过75%，发布者得到另外的10个蝌蚪。
[*]票数超过100，其中认为“有趣”比例超过75%，发布者得到另外的10个蝌蚪。
[*]票数超过200，其中认为“有趣”比例超过75%，发布者得到另外的10个蝌蚪。',
    ),
    11 =>
    array (
        'id' => 11,
...
[*]票數超過25，其中認為“有趣”比例超過50%，發布者得到5個蝌蚪。
[*]票數超過50，其中認為“有趣”比例超過50%，發布者得到另外的5個蝌蚪。
[*]票數超過100，其中認為“有趣”比例超過50%，發布者得到另外的5個蝌蚪。
[*]票數超過200，其中認為“有趣”比例超過50%，發布者得到另外的5個蝌蚪。
[*]票數超過25，其中認為“有趣”比例超過75%，發布者得到10個蝌蚪。
[*]票數超過50，其中認為“有趣”比例超過75%，發布者得到另外的10個蝌蚪。
[*]票數超過100，其中認為“有趣”比例超過75%，發布者得到另外的10個蝌蚪。
[*]票數超過200，其中認為“有趣”比例超過75%，發布者得到另外的10個蝌蚪。',
    ),
    15 =>
    array (
        'id' => 21,
...
[*]对每一例不合格字幕的举报，确认后将奖励举报者50点蝌蚪（三天内发放）。
[*]被确定为不合格的字幕将被删除，而在每一例中，相应的字幕上传者将被扣除100点蝌蚪。
[*]对为赚取积分等目的恶意上传不合格字幕的用户，或是恶意举报的用户，将视情节轻重扣除额外的蝌蚪甚至给予警告。
',
    ),
    28 =>
    array (
...
[*]對每一例不合格字幕的舉報，確認後將獎勵舉報者50點蝌蚪（三天內發放）。
[*]被確定為不合格的字幕將被刪除，而在每一例中，相應的字幕上傳者將被扣除100點蝌蚪。
[*]對為賺取積分等目的惡意上傳不合格字幕的用戶，或是惡意舉報的用戶，將視情節輕重扣除額外的蝌蚪甚至給予警告。
',
    ),
));
